...
ActiveRecord::Schema[7.2].define(version: 2024_10_09_121309) do
  ...
  create_table "custom_fields", force: :cascade do |t|
    ...
    t.index ["client_id", "field_name"], name: "index_custom_fields_on_client_id_and_field_name", unique: true
